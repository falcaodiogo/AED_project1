...
// static void sol2(int move_number, int position, int speed, int final_position)
// {
//   int i, new_speed;
//   while (position <= final_position) // enquanto não for posição final
//   {
//     solution_2_count++;
...
//         if (i > new_speed) // se a velocidade for válida
//         {
//           move_number++;
//           position += new_speed;
//           speed = new_speed;
